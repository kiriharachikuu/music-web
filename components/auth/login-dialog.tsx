...
export function LoginDialog() {
  ...
  return (
    ...
    >
      <DialogContent className="max-w-md overflow-hidden border-white/10 bg-gradient-to-br from-primary/90 via-primary/95 to-gray-950 p-0 text-white sm:rounded-3xl">
        {/* 装饰光晕 */}
