  ...
  return (
    <div className="min-h-dvh">
      ...
      <div className="md:pl-64">
        <TopNav />
        <main className="mx-auto max-w-[1400px] px-4 pb-44 pt-[calc(var(--safe-area-top,0px)+3.5rem)] md:px-6 md:pb-32 md:pt-[calc(var(--safe-area-top,0px)+4rem)] landscape:pb-36">
          {children}
        </main>
      </div>
