...
export function MiniPlayer() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-[calc(3.5rem+var(--safe-area-bottom,0px))] max-md:landscape:bottom-[calc(3rem+var(--safe-area-bottom,0px))] z-40 md:bottom-0 md:left-64 md:z-40 platform-twa:bottom-14">
