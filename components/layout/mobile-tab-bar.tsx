...
export function MobileTabBar() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-30 flex min-h-14 items-stretch border-t border-primary-500/10 bg-white/90 pb-safe backdrop-blur-xl dark:bg-gray-900/80 md:hidden landscape:min-h-12 platform-twa:pb-0">
      {navItems.map((item) => {
